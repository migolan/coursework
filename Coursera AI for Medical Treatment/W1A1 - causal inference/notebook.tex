...
representations.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{n}{data} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{data/levamisole\PYZus{}data.csv}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{index\PYZus{}col}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
\end{Verbatim}
...
survival rate, which is captured in the \texttt{outcome} variable.
     ...
     \#\#\# Exercise 1 - proportion\_treated
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{} UNQ\PYZus{}C1 (UNIQUE CELL IDENTIFIER, DO NOT EDIT)}
        ...
        \PY{l+s+sd}{  }
        \PY{l+s+sd}{    Returns:}
        \PY{l+s+sd}{        result (float64): proportion of patients who were treated}
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            
            \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} START CODE HERE (REPLACE INSTANCES OF \PYZsq{}None\PYZsq{} with your code) \PYZsh{}\PYZsh{}\PYZsh{}}
        
            \PY{n}{proportion} \PY{o}{=} \PY{n}{df}\PY{o}{.}\PY{n}{TRTMT}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{p}{)}\PY{o}{/}\PY{n}{df}\PY{o}{.}\PY{n}{TRTMT}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} test cell ex1: you cannot edit this cell}
        \PY{n}{proportion\PYZus{}treated\PYZus{}test}\PY{p}{(}\PY{n}{proportion\PYZus{}treated}\PY{p}{)}   
\end{Verbatim}
...
\end{verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{p} \PY{o}{=} \PY{n}{proportion\PYZus{}treated}\PY{p}{(}\PY{n}{data}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Proportion Treated: 0.49093904448105435 \textasciitilde{} 49\%

    \end{Verbatim}

     \#\#\# Exercise 2 - event\_rate
...
treatment).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}70}]:} \PY{c+c1}{\PYZsh{} UNQ\PYZus{}C2 (UNIQUE CELL IDENTIFIER, DO NOT EDIT)}
         ...
         \PY{l+s+sd}{  }
         \PY{l+s+sd}{    Returns:}
         \PY{l+s+sd}{        treated\PYZus{}prob (float64): empirical probability of death given treatment}
         \PY{l+s+sd}{        untreated\PYZus{}prob (float64): empirical probability of death given control}
         \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
             ...
             \PY{n}{treated\PYZus{}prob} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{n}{df}\PY{o}{.}\PY{n}{outcome} \PY{o}{\PYZam{}} \PY{n}{df}\PY{o}{.}\PY{n}{TRTMT}\PY{p}{)}\PY{o}{/}\PY{n}{df}\PY{o}{.}\PY{n}{TRTMT}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{p}{)}
             \PY{n}{control\PYZus{}prob} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{n}{df}\PY{o}{.}\PY{n}{outcome} \PY{o}{\PYZam{}} \PY{o}{\PYZti{}}\PY{n}{df}\PY{o}{.}\PY{n}{TRTMT}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n}{df}\PY{o}{.}\PY{n}{TRTMT}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{n}{df}\PY{o}{.}\PY{n}{TRTMT}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}71}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} test cell ex2: you cannot edit this cell}
         \PY{n}{event\PYZus{}rate\PYZus{}test}\PY{p}{(}\PY{n}{event\PYZus{}rate}\PY{p}{)}
\end{Verbatim}
...
\end{verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}72}]:} \PY{n}{treated\PYZus{}prob}\PY{p}{,} \PY{n}{control\PYZus{}prob} \PY{o}{=} \PY{n}{event\PYZus{}rate}\PY{p}{(}\PY{n}{data}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Death rate for treated patients: 0.3725 \textasciitilde{} 37\%
Death rate for untreated patients: 0.4822 \textasciitilde{} 48\%
...
models later on.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}73}]:} \PY{c+c1}{\PYZsh{} As usual, split into dev and test set}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}74}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dev set shape: }\PY{l+s+si}{\PYZob{}X\PYZus{}dev.shape\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
a validation set.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}75}]:} \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{linear\PYZus{}model} \PY{k}{import} \PY{n}{LogisticRegression}
...
\paragraph{Calculating the Odds
...
\[ OddsRatio = e^{\theta_{treatment}}\]
     ...
     \#\#\# Exercise 3 - extract\_treatment\_effect
...
from the logistic regression model.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}82}]:} \PY{c+c1}{\PYZsh{} UNQ\PYZus{}C3 (UNIQUE CELL IDENTIFIER, DO NOT EDIT)}
         ...
         \PY{l+s+sd}{        data (pandas DataFrame): records of records of individuals/patients}
         \PY{l+s+sd}{  }
         \PY{l+s+sd}{    Returns:}
         \PY{l+s+sd}{        theta\PYZus{}TRTMT (float): the effect of treatment}
         \PY{l+s+sd}{        TRTMT\PYZus{}OR (float): odds for treatment relative to the odds for the baseline}
         \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}83}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} test cell ex3: you cannot edit this cell}
         \PY{n}{extract\PYZus{}treatment\PYZus{}effect\PYZus{}test}\PY{p}{(}\PY{n}{extract\PYZus{}treatment\PYZus{}effect}\PY{p}{,} \PY{n}{lr}\PY{p}{,} \PY{n}{X\PYZus{}dev}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
Theta\_TRTMT: -0.2885162279475891
...
paper.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}86}]:} \PY{c+c1}{\PYZsh{} UNQ\PYZus{}C4 (UNIQUE CELL IDENTIFIER, DO NOT EDIT)}
         ...
         \PY{l+s+sd}{      \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{n}{p\PYZus{}trtmt} \PY{o}{=} \PY{n}{odds\PYZus{}trtmt}\PY{o}{/}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{+}\PY{n}{odds\PYZus{}trtmt}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}87}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} test cell ex4: you cannot edit this cell}
         \PY{n}{OR\PYZus{}to\PYZus{}ARR\PYZus{}test}\PY{p}{(}\PY{n}{OR\PYZus{}to\PYZus{}ARR}\PY{p}{)}
\end{Verbatim}
...
for the logistic regression model.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}88}]:} \PY{n}{ps} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mf}{0.001}\PY{p}{,} \PY{l+m+mf}{0.999}\PY{p}{,} \PY{l+m+mf}{0.001}\PY{p}{)}
...
\[ARR_{empirical} = p_{baseline} - p_{treatment}\]
     ...
     \#\#\# Exercise 5 - base\_risks In the next cell, write a function to
...
the order of the classes by using lr.classes\_
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}110}]:} \PY{c+c1}{\PYZsh{} UNQ\PYZus{}C5 (UNIQUE CELL IDENTIFIER, DO NOT EDIT)}
          ...
          \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
              ...
              \PY{n}{X}\PY{o}{.}\PY{n}{TRTMT} \PY{o}{=} \PY{k+kc}{False}
              
              \PY{c+c1}{\PYZsh{} Input the features into the model, and predict the probability of death.}
              \PY{n}{risks} \PY{o}{=} \PY{n}{lr\PYZus{}model}\PY{o}{.}\PY{n}{predict\PYZus{}proba}\PY{p}{(}\PY{n}{X}\PY{p}{)}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}111}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} test cell ex5: you cannot edit this cell}
          \PY{n}{base\PYZus{}risks\PYZus{}test}\PY{p}{(}\PY{n}{base\PYZus{}risks}\PY{p}{,} \PY{n}{X\PYZus{}dev}\PY{p}{,} \PY{n}{lr}\PY{p}{)}
\end{Verbatim}
...
column 1, and then calculates the sum of column 2 for each group.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} UNQ\PYZus{}C6 (UNIQUE CELL IDENTIFIER, DO NOT EDIT)}
        ...
        \PY{l+s+sd}{    }
        \PY{l+s+sd}{    Returns:}
        \PY{l+s+sd}{        arr\PYZus{}by\PYZus{}risk\PYZus{}group (pandas Series): empirical average ARR for each }
        \PY{l+s+sd}{                                           quantile of base risk}
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{n}{baseline\PYZus{}risk} \PY{o}{=} \PY{k+kc}{None}
            
            \PY{c+c1}{\PYZsh{} bin patients into 10 risk groups based on their baseline risks}
            \PY{n}{risk\PYZus{}groups} \PY{o}{=} \PY{k+kc}{None}
                
            \PY{c+c1}{\PYZsh{} Store the baseline risk, risk\PYZus{}groups, and y into the new dataframe}
            \PY{n}{df}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{baseline\PYZus{}risk}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{k+kc}{None}
            \PY{n}{df}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{risk\PYZus{}group}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{k+kc}{None}
            \PY{n}{df}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{y}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{k+kc}{None}
        
            \PY{c+c1}{\PYZsh{} select the subset of patients who did not actually receive treatment}
            \PY{n}{df\PYZus{}baseline} \PY{o}{=} \PY{k+kc}{None}
            
            \PY{c+c1}{\PYZsh{} select the subset of patients who did actually receive treatment}
            \PY{n}{df\PYZus{}treatment} \PY{o}{=} \PY{k+kc}{None}
            
            \PY{c+c1}{\PYZsh{} For baseline patients, group them by risk group, select their outcome \PYZsq{}y\PYZsq{}, and take the mean}
            \PY{n}{baseline\PYZus{}mean\PYZus{}by\PYZus{}risk\PYZus{}group} \PY{o}{=} \PY{k+kc}{None}
            
            \PY{c+c1}{\PYZsh{} For treatment patients, group them by risk group, select their outcome \PYZsq{}y\PYZsq{}, and take the mean}
            \PY{n}{treatment\PYZus{}mean\PYZus{}by\PYZus{}risk\PYZus{}group} \PY{o}{=} \PY{k+kc}{None}
            
            \PY{c+c1}{\PYZsh{} Calculate the absolute risk reduction by risk group (baseline minus treatment)}
            \PY{n}{arr\PYZus{}by\PYZus{}risk\PYZus{}group} \PY{o}{=} \PY{k+kc}{None}
            ...
            \PY{n}{arr\PYZus{}by\PYZus{}risk\PYZus{}group}\PY{o}{.}\PY{n}{index} \PY{o}{=} \PY{k+kc}{None}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} test cell ex6: you cannot edit this cell}
        \PY{n}{lr\PYZus{}ARR\PYZus{}quantile\PYZus{}test}\PY{p}{(}\PY{n}{lr\PYZus{}ARR\PYZus{}quantile}\PY{p}{,} \PY{n}{X\PYZus{}dev}\PY{p}{,} \PY{n}{y\PYZus{}dev}\PY{p}{,} \PY{n}{lr}\PY{p}{)}
\end{Verbatim}
...
\NormalTok{Name: ARR, dtype: float64 }
\end{Highlighting}
\end{Shaded}
...
\end{verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{abs\PYZus{}risks} \PY{o}{=} \PY{n}{lr\PYZus{}ARR\PYZus{}quantile}\PY{p}{(}\PY{n}{X\PYZus{}dev}\PY{p}{,} \PY{n}{y\PYZus{}dev}\PY{p}{,} \PY{n}{lr}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n}{abs\PYZus{}risks}\PY{o}{.}\PY{n}{index}\PY{p}{,} \PY{n}{abs\PYZus{}risks}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{empirical ARR}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\texttt{(1,\ 1)}, the observed benefit of treatment is 0.
...
treatment) has a predicted benefit of 0.40 and dies.
     ...
     \#\#\# Exercise 7 - c\_for\_benefit\_score In
...
a permissible pair of pairs.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} UNQ\PYZus{}C7 (UNIQUE CELL IDENTIFIER, DO NOT EDIT)}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{n}{obs\PYZus{}benefit} \PY{o}{=} \PY{k+kc}{None}
        
            \PY{c+c1}{\PYZsh{} compute average predicted benefit for each pair}
            \PY{n}{pred\PYZus{}benefit} \PY{o}{=} \PY{k+kc}{None}
            ...
            \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{pairs}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{i} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{pairs}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                    ...
                    \PY{k}{if} \PY{n}{obs\PYZus{}benefit}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{!=} \PY{n}{obs\PYZus{}benefit}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{:}
                        ...
                        \PY{k}{if} \PY{p}{(}\PY{k+kc}{False}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{} change to check for concordance}
                            
                            \PY{k}{pass}
        
                        \PY{c+c1}{\PYZsh{} if risk tie, increment count}
                        \PY{k}{if} \PY{p}{(}\PY{k+kc}{False}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{}change to check for risk ties}
                            \PY{k}{pass}
        
        
            \PY{c+c1}{\PYZsh{} compute c\PYZhy{}statistic\PYZhy{}for\PYZhy{}benefit}
            \PY{n}{cstat} \PY{o}{=} \PY{k+kc}{None}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} test cell ex7: you cannot edit this cell}
        \PY{n}{c\PYZus{}for\PYZus{}benefit\PYZus{}score\PYZus{}test}\PY{p}{(}\PY{n}{c\PYZus{}for\PYZus{}benefit\PYZus{}score}\PY{p}{)}
\end{Verbatim}
...
by their value in index 1.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} UNQ\PYZus{}C8 (UNIQUE CELL IDENTIFIER, DO NOT EDIT)}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{c+c1}{\PYZsh{} randomly choose a subset of untreated patients, one for each treated patient (length of treated patients).}
            ...
            \PY{c+c1}{\PYZsh{} randomly choose a subset of treated patients, one for each untreated patient (length of untreated patients).}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} test cell ex8: you cannot edit this cell}
        \PY{n}{c\PYZus{}statistic\PYZus{}test}\PY{p}{(}\PY{n}{c\PYZus{}statistic}\PY{p}{)}
\end{Verbatim}
...
We've implemented this for you.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k}{def} \PY{n+nf}{treatment\PYZus{}control}\PY{p}{(}\PY{n}{X}\PY{p}{)}\PY{p}{:}
...
regression model on the test set.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{X\PYZus{}test\PYZus{}treated}\PY{p}{,} \PY{n}{X\PYZus{}test\PYZus{}untreated} \PY{o}{=} \PY{n}{treatment\PYZus{}control}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{)}
...
histogram of predicted ARR.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{rr\PYZus{}lr}\PY{p}{,} \PY{n}{bins}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{auto}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
the c-statistic-for-benefit on the test data.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{tmp\PYZus{}cstat\PYZus{}test} \PY{o}{=} \PY{n}{c\PYZus{}statistic}\PY{p}{(}\PY{n}{rr\PYZus{}lr}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{o}{.}\PY{n}{TRTMT}\PY{p}{)}
...
\end{Shaded}
    ...
    Recall that an c statistic ranges from 0 to 1, and is closer to when the
...
reduction, given a c-for-benefit of around 0.43.
...
treatment.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k+kn}{from} \PY{n+nn}{lifelines}\PY{n+nn}{.}\PY{n+nn}{utils} \PY{k}{import} \PY{n}{concordance\PYZus{}index}
...
You can group patients by deciles (10 groups) of risk.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k}{def} \PY{n+nf}{quantile\PYZus{}benefit}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{arr\PYZus{}hat}\PY{p}{)}\PY{p}{:}
            \PY{n}{df} \PY{o}{=} \PY{n}{X}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{n}{deep}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\item
  The \texttt{predict} function takes the featuers and uses each
  estimator to predit the risk of death. Then it calculates the risk of
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} UNQ\PYZus{}C9 (UNIQUE CELL IDENTIFIER, DO NOT EDIT)}
        ...
        \PY{l+s+sd}{        \PYZdq{}\PYZdq{}\PYZdq{}}
                ...
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{treatment\PYZus{}estimator} \PY{o}{=} \PY{k+kc}{None}
                
                \PY{c+c1}{\PYZsh{} set the control estimator }
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{control\PYZus{}estimator} \PY{o}{=} \PY{k+kc}{None}
        ...
        \PY{l+s+sd}{        \PYZdq{}\PYZdq{}\PYZdq{}}
                ...
                \PY{n}{risk\PYZus{}control} \PY{o}{=} \PY{k+kc}{None}
                
                \PY{c+c1}{\PYZsh{} predict the risk of death using the treatment estimator}
                \PY{n}{risk\PYZus{}treatment} \PY{o}{=} \PY{k+kc}{None}
...
\paragraph{Tune the model with grid
...
- Identify and return the best performing model.
     ...
     \#\#\# Exercise 10 - holdout\_grid\_search
...
To generate the list of dictionaries, loop through the list of tuples.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} UNQ\PYZus{}C10 (UNIQUE CELL IDENTIFIER, DO NOT EDIT)}
        ...
        \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
            ...
            \PY{n}{hyper\PYZus{}param\PYZus{}l} \PY{o}{=} \PY{k+kc}{None}
            
            \PY{c+c1}{\PYZsh{} Generate a list of tuples with all possible combinations of the hyperparams}
            \PY{n}{combination\PYZus{}l\PYZus{}of\PYZus{}t} \PY{o}{=} \PY{k+kc}{None}
            ...
            \PY{k}{for} \PY{n}{val\PYZus{}tuple} \PY{o+ow}{in} \PY{k+kc}{None}\PY{p}{:} \PY{c+c1}{\PYZsh{} complete this line}
                \PY{n}{param\PYZus{}d} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
                
                \PY{c+c1}{\PYZsh{} Enumerate each key in the original hyperparams dictionary}
                \PY{k}{for} \PY{n}{i}\PY{p}{,} \PY{n}{k} \PY{o+ow}{in} \PY{k+kc}{None}\PY{p}{:} \PY{c+c1}{\PYZsh{} complete this line}
                    
                    \PY{c+c1}{\PYZsh{} add a key value pair to param\PYZus{}d for each value in val\PYZus{}tuple}
                    \PY{n}{param\PYZus{}d}\PY{p}{[}\PY{n}{k}\PY{p}{]} \PY{o}{=} \PY{k+kc}{None}
            ...
            \PY{k}{for} \PY{n}{param\PYZus{}d} \PY{o+ow}{in} \PY{k+kc}{None}\PY{p}{:} \PY{c+c1}{\PYZsh{} complete this line}
                
                \PY{c+c1}{\PYZsh{} Set the model to the given hyperparams}
                \PY{n}{estimator} \PY{o}{=} \PY{k+kc}{None}
                ...
                \PY{n}{estimator\PYZus{}score} \PY{o}{=} \PY{k+kc}{None}
                
                \PY{c+c1}{\PYZsh{} if the model\PYZsq{}s c\PYZhy{}index is better than the previous best:}
                \PY{k}{if} \PY{k+kc}{None}\PY{p}{:} \PY{c+c1}{\PYZsh{} complete this line}
                    ...
                    \PY{n}{best\PYZus{}hyperparam} \PY{o}{=} \PY{k+kc}{None}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} test cell ex10: you cannot edit this cell}
        \PY{n}{holdout\PYZus{}grid\PYZus{}search\PYZus{}test}\PY{p}{(}\PY{n}{holdout\PYZus{}grid\PYZus{}search}\PY{p}{,} \PY{n}{X\PYZus{}dev}\PY{p}{,} \PY{n}{y\PYZus{}dev}\PY{p}{)}
\end{Verbatim}
...
\end{verbatim}
     ...
     \#\#\# Exercise 11 - treatment\_dataset\_split
...
index label)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} UNQ\PYZus{}C11 (UNIQUE CELL IDENTIFIER, DO NOT EDIT)}
        ...
        \PY{l+s+sd}{    datasets should NOT contain the \PYZsq{}TRTMT\PYZsq{} column!}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{n}{X\PYZus{}treat\PYZus{}train} \PY{o}{=} \PY{k+kc}{None}
        ...
        \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
            ...
            \PY{n}{X\PYZus{}control\PYZus{}train} \PY{o}{=} \PY{k+kc}{None}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} test cell ex11: you cannot edit this cell}
        \PY{n}{treatment\PYZus{}dataset\PYZus{}split\PYZus{}test}\PY{p}{(}\PY{n}{treatment\PYZus{}dataset\PYZus{}split}\PY{p}{)}
\end{Verbatim}
...
First, get the training and validation sets.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} Import the random forest classifier to be used as the base learner}
...
Similarly, split the validation set into a treatment and control set.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} get treatment and control arms of training and validation sets}
...
\end{Shaded}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} hyperparameter grid (we\PYZsq{}ll use the same one for both arms for convenience)}
        \PY{c+c1}{\PYZsh{} Note that we set the random\PYZus{}state to 0}
        \PY{c+c1}{\PYZsh{} in order to get consistent outputs each time the code is run,}
...
hyperparameters with the best c-index (the regular c-index).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} perform grid search with the treatment data to find the best model }
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} perform grid search with the control data to find the best model }
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} Save the treatment and control models into an instance of the TLearner class}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} calculate the c\PYZhy{}for\PYZhy{}benefit of the t\PYZhy{}learner on the test set}
